...
var today = new Date(); //Crea la fecha
var year = today.getFullYear(); //Obtiene el año del sistema
var month = (today.getMonth() + 1).toString().padStart(2, "0"); // Los meses son indexados desde 0
var day = today.getDate().toString().padStart(2, "0");
var formattedDate = `${year}-${month}-${day}`; //Convierte la fecha en un string
...
window.generate = function generate() {
  ...
  //Carga el documento del enlace de google sheets
  loadFile(
    ...
    function (error, content) {
      ...
      // En sections estan los marcadores para reemplazar en los documentos
...
//Funcion de limpiar todos los inputs iterando con los ID de los elementos
...
function addSection() {
  ...
  //Elimina los elementos que tienen la clase de "NuevaSec"
